...
function composeJsDoc(name, obj) {
...
function clearJsDocProperties(style) {
...
async function processTypes(loadFromDir, modules = { global: {} }) {
...
module.exports = { composeJsDoc, clearJsDocProperties, processTypes };
